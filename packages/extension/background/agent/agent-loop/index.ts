...
import { createBenchmarkContextBuilder, createInitialDiagnostics, createLatencyMetricsBuilder } from './diagnostics.js';
import {
...
import { prepareAgentLoopRun } from './prepare.js';
import { resolveAgentResponse } from './response.js';
import type { RecordedContext } from './shared.js';
...
export async function processUserMessage(
  ...
  const origin: 'sidepanel' = meta?.origin || 'sidepanel';
